...
À compter du 11 décembre 2025 | [Versions archivées](https://policies.google.com/privacy/archive?hl=fr-FR&gl=FR) | [Télécharger au format PDF](https://www.gstatic.com/policies/privacy/pdf/20251211/mfsjkv52/google_privacy_policy_fr_eu.pdf)
...
Lorsque nous détectons sur nos systèmes du spam, des logiciels malveillants, du contenu illégal (y compris des [contenus d'abus sexuels sur mineurs ou liés à l'exploitation des enfants](https://protectingchildren.google/?hl=fr)) et d'autres formes d'abus qui ne respectent pas nos règles, nous sommes susceptibles de désactiver votre compte ou de prendre d'autres mesures appropriées. Dans certains cas, nous pouvons également signaler les cas de non-respect aux autorités compétentes.
...
### utiliser les informations que nous collectons via nos services

Selon les paramètres dont vous disposez, voici quelques exemples de la façon dont nous utilisons les informations que nous collectons via nos services :
...
* Si vous êtes un utilisateur situé dans l'Union européenne, les décisions que vous prenez concernant l'association des services ont une incidence sur la manière dont certains services Google peuvent utiliser les données collectées.
